...
func transfer_token() {
	...
	tokenAddress := common.HexToAddress("0x3986C657C4597064825b4eaeC2FFac4fc501644f")
	...
	fmt.Println(hexutil.Encode(paddedAddress)) // 0x0000000000000000000000000cf49c38028dc3d38b77f53a8cf9adb079718941

	amount := new(big.Int)
	amount.SetString("10000000000000000000", 10) // 10 tokens
	paddedAmount := common.LeftPadBytes(amount.Bytes(), 32)
	fmt.Println(hexutil.Encode(paddedAmount)) // 0x0000000000000000000000000000000000000000000000008ac7230489e80000
